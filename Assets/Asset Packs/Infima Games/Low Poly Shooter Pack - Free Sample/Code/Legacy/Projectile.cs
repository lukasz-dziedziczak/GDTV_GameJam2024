...
public class Projectile : MonoBehaviour {
	...
	{
		//print("projectile impact on layer = " + collision.gameObject.layer);
		/*if (Includes(groundLayer, collision.gameObject.layer))
		{
			print("hit ground layer");
		}*/
		...
		/*if (collision.transform.tag == "Concrete") */ else
		{
			//Instantiate random impact prefab from array
